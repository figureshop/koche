...
const app = {
    ...
    songsData : [
        ...
        },
        {
            ...
            name: 'Vui Lắm Nha',
            singer: 'Hương Ly, Jombie, RIN Music Remix',
        ...
        },
        {
            ...
            name: 'Lưu Số Em Đi',
            singer: 'Huỳnh Văn, V.P. Tiên, Đại Mèo Remix',
        ...
        },
        {
            ...
            singer: 'Phát Huy T4, Đại Mèo Remix',
        ...
        },
        {
            ...
            singer: 'Đinh Tùng Huy, ACV Remix',
        ...
        },
        {
            ...
            singer: 'Ngô Lan Hương, Đại Mèo remix',
    ...
    renderNextSongHeaddingStart: function(playListElement){
        const htmls = this.songsData.map((song, index) => {
            return index <= this.currentIndex ? `
            <!-- nextsong__fist-item-headding--active nextsong__fist-item-playbtn--active-->
    ...
    verifyOptionTextColor: function() {
        $$('.music__option-item').forEach((tab) => {
    ...
    handleEvents: function () {
       ...
       function deleteActive() {
        ...
        function deleteActive1() {
            songItemsOption1.forEach((songItem) => {
                songItem.classList.remove('songs-item-playing--active-onplay');
                songItem.classList.remove('songs-item--active');
                songItem.classList.remove('songs-item-playbtn--active');
            });
